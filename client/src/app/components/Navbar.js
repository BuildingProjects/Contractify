        ...
        {isOpen && (
          <div className="md:hidden py-4">
            <div className="flex flex-col gap-4">
              ...
              <Link href="/about" className="text-gray-600 hover:text-gray-900 px-4 py-2">
                About
              </Link>
              <Link href="/service" className="text-gray-600 hover:text-gray-900 px-4 py-2">
                Service
              </Link>
              <Link href="/portfolio" className="text-gray-600 hover:text-gray-900 px-4 py-2">
                Portfolio
              </Link>
