...
const Navbar = () => {
  ...
  return (
    <nav className="w-full pt-2 z-50 from-[#FFF5EB] to-white backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button className="text-lg font-medium bg-black text-white px-6 py-2.5 rounded-lg hover:bg-gray-800 transition-all">
              Get Started
            </button>
          </div>
